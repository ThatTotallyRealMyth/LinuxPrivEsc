...
- [Methodology Checklist](#methodology-checklist)
  ...
  - [2. Privilege Escalation Vectors](#2-privilege-escalation-vectors)
- [Initial Enumeration & Strategy](#initial-enumeration--strategy)
  - [Privilege Escalation Strategy](#privilege-escalation-strategy)
  - [Process Enumeration](#process-enumeration)
  - [Essential Enumeration Scripts](#essential-enumeration-scripts)
  - [Advanced Process Monitoring](#advanced-process-monitoring)
- [Credentials & Sensitive Data Hunting](#credentials--sensitive-data-hunting)
  - [Sensitive Files to Check for Weak Permissions](#sensitive-files-to-check-for-weak-permissions)
  ...
  - [System / Service Configuration Files](#system--service-configuration-files)
  - [Command History](#command-history)
  - [Recursive Search](#recursive-search)
- [Sudo Exploitation](#sudo-exploitation)
  - [Understanding Sudo Rights](#understanding-sudo-rights)
  - [General Enumeration](#general-enumeration)
  - [Sudo Configuration Analysis](#sudo-configuration-analysis)
  - [Exploiting NOPASSWD Entries](#exploiting-nopasswd-entries)
  - [LD_PRELOAD Exploitation](#ld_preload-exploitation)
- [File, Group, and Permission Abuse](#file-group-and-permission-abuse)
  - [File Permission Exploitation](#file-permission-exploitation)
  - [Finding World-Writable Files](#finding-world-writable-files)
  - [Group Membership Exploitation](#group-membership-exploitation)
  - [Common Group-based Privilege Escalation Paths](#common-group-based-privilege-escalation-paths)
- [Cron Job Exploitation](#cron-job-exploitation)
  - [Enumeration](#enumeration)
  - [File Overwrite Attack](#file-overwrite-attack)
  - [PATH Variable Attack](#path-variable-attack)
  - [Python Module Hijacking](#python-module-hijacking)
  - [Wildcard Injection Attack](#wildcard-injection-attack)
- [SUID, SGID, and Capabilities](#suid-sgid-and-capabilities)
  - [SUID/SGID Binary Exploitation](#suidsgid-binary-exploitation)
  - [Linux File Capabilities Exploitation](#linux-file-capabilities-exploitation)
  ...
  - [RPATH / RUNPATH in Shared Objects](#rpath--runpath-in-shared-objects)
  - [One-liners to Hunt for Vulnerable SUID Binaries](#one-liners-to-hunt-for-vulnerable-suid-binaries)
  - [Environment Variable Exploitation](#environment-variable-exploitation)
  - [Abusing Shell Features (Bash < 4.2-048)](#abusing-shell-features-bash--42048)
  - [Abusing Bash Debugging Mode (Bash < 4.4)](#abusing-bash-debugging-mode-bash--44)
  - [Finding Vulnerable SUID Binaries (Advanced)](#finding-vulnerable-suid-binaries-advanced)
- [Startup Script & Service Exploitation](#startup-script--service-exploitation)
  - [Identifying Vulnerable Startup Scripts](#identifying-vulnerable-startup-scripts)
  - [Script Modification Attack](#script-modification-attack)
  - [Identifying Vulnerable Services](#identifying-vulnerable-services)
  - [One-liners to Identify Service Vulnerabilities](#one-liners-to-identify-service-vulnerabilities)
- [Service Exploitation](#service-exploitation)
  - [MySQL Exploitation](#mysql-exploitation)
  - [Apache Exploitation](#apache-exploitation)
  - [Tomcat Manager Exploitation](#tomcat-manager-exploitation)
- [Network / Mounted Resource Abuse](#network--mounted-resource-abuse)
  - [NFS Root Squashing Exploitation](#nfs-root-squashing-exploitation)
  - [Port Forwarding for Internal Services](#port-forwarding-for-internal-services)
...
## Credentials & Sensitive Data Hunting
...
## File, Group, and Permission Abuse
...
## Network / Mounted Resource Abuse
...
Last Resort, High chance it wont work + never use it IRL
